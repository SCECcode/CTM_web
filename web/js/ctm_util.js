...
//
// allow multiple bin files from uctmc's plotting utilities
// example
//       BC_ctms5_gate_vs.svg or BC_ctms5_gate_vs.png	
//       BC_ctms5_gate_vs_meta.json
//       BC_ctms5_gate_vs_data.bin
//
...
//      var metaurl=makeMetaFname(url);
      var metaurl="BC_ctms5_gate_vs_meta.json";
      ...
      var ctm=meta['ctm_selected'];
      var title = " TEST"+ctm+" ("+lat1.toFixed(2)+","+lon1.toFixed(2)+" to "+lat2.toFixed(2)+","+lon2.toFixed(2)+")"
