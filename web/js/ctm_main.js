...
*/
  ...
  $("#ctm-model-cfm").on('click', function () {
  ...
  $("#ctm-model-gfm").change(function() {
    if ($("#ctm-model-gfm").prop('checked')) { 
  ...
  $('#modalplotoption').on('show.bs.modal', function (event) {
    // button that triggered the modal
 	...
 	let json=JSON.parse(blob);
        ...
        // switch from ../reslut/pdffile to /ctm-explorer/result/pdffile 
//window.console.log("  myfile is  -->", myfile);
        MODAL_REPLOT_SRC=myfile.replace("..","/research/ctm-explorer");
