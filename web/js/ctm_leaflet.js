...
// ==> mymap <==
  mymap = L.map('CTM_plot', { zoomSnap: 0.25, drawControl:false, zoomControl:true, maxZoom:16} );
...
//          CTM.processByLatlonForLine(1)
        }
    }
  });

// enable the expand view key
  $("#CTM_plot").prepend($("#expand-view-key-container").html());
