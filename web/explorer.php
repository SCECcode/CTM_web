...
<html lang="en">
<head>
    <title>SCEC Community Thermal Model Explorer</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="css/ctm-ui.css">
    ...
    <script type="text/javascript" src="js/ctm_layer.js"></script>
    <script type="text/javascript" src="js/ctm_util.js"></script>
    <script type="text/javascript" src="js/ctm_ui.js"></script>
    <script type="text/javascript" src="js/ctm_main.js"></script>
    <script type="text/javascript" src="js/ctm_query.js"></script>
    <script type="text/javascript" src="js/ctm_select.js"></script>
    <script type="text/javascript" src="js/ctm_state.js"></script>
    <script type="text/javascript" src="js/ctm_leaflet.js"></script>
    <script type="text/javascript" src="js/ctm_region.js"></script>
    <script type="text/javascript" src="js/ctm_region_util.js"></script>
    <script type="text/javascript" src="js/ctm_expand.js"></script>
            ...
            <div id='model-options' class="form-check-inline">
                <div class="form-check form-check-inline">
                     ...
                     <input class='form-check-inline mr-1'
                             type="checkbox"
                             id="ctm-model-cfm" value="1" />CFM7.0
                     </label>
                </div>
    ...
    <div id="mapDataBig" class="row mapData">
        <div id="search-container" class="col-5 button-container flex-column pr-0" style="overflow:hidden;border:solid 0px green;">
            ...
            <div class="input-group input-group-sm custom-control-inline" style="max-width:450px;border:solid 0px green;">
               <div class="input-group-prepend">
                     <label class="input-group-text" for="selectModelType">Select CTM Model</label>
               </div>
	       <select id="selectModelType" class="custom-select custom-select-sm"></select>&nbsp;

               <button class="btn ctm-top-small-btn" data-toggle="modal" data-target="#modalmodeltype"><span class="glyphicon glyphicon-info-sign"></span></button>
                                ...
                                <div class="row d-flex mt-1">
                                    <div class="col-5 pr-0">
                                        <div class="col-12" style="padding:5px 0px 10px 0px">
                                               <button class="btn btn-dark" onclick="CTM.resetAll()" style="width:100%;border-radius:0.25rem">Reset All</button>
                                        </div>
                                    </div>
                                    <div class="col-5 pr-0">
                                        <div class="col-12" style="padding:5px 0px 10px 0px">
                                               <button id="pointBtn" class="btn btn-dark" onclick="CTM.processByLatlonForPoint(0)" style="width:100%;border-radius:0.25rem">Extract Data</button>
                                        </div>
                                    </div>
                                </div>
...
<button class="btn ctm-top-small-btn" data-toggle="modal" data-target="#modalprofilefile"><span class="glyphicon glyphicon-info-sign"></span></button>
                                ...
                                <div class="row d-flex mt-1">
                                    ...
                                    <div class="col-5 pr-0">
                                        <div class="col-12" style="padding:5px 0px 10px 0px">
                                          <button id="profileBtn" class="btn btn-dark" onclick="CTM.processByLatlonForProfile(0)" style="width:100%;border-radius:0.25rem">Extract Data</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li id='line' class='navigationLi ' style="display:none">
                            <div id='lineMenu' class='menu'>
                                ...
                                <div class="row d-flex mt-1">
                                    ...
                                    <div class="col-5 pr-0">
                                        <div class="col-12" style="padding:5px 0px 10px 0px">
                                          <button id="lineBtn" class="btn btn-dark" onclick="CTM.processByLatlonForLine(0)" style="width:100%;border-radius:0.25rem">Extract Data</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
-->
					       ...
					       <button class="btn btn-dark" onclick="CTM.resetAll()" style="width:100%;border-radius:0.25rem">Reset All</button>
                                    ...
                                    <div class="col-5 pr-0">
                                        <div class="col-12" style="padding:5px 0px 10px 0px">
                                               <button id="areaBtn" class="btn btn-dark" onclick="CTM.processByLatlonForArea(0)" style="width:100%;border-radius:0.25rem">Extract Data</button>
                                        </div>
                                    </div>
                                </div>
...
<!-- description page -->
            <div id="ctm-description" class="col-12 pr-5" style="display:;border:solid 0px blue" >
...
<!-- leaflet 2D map -->
        <div id="map-container" class="col-7 pl-2">
            <div class="w-100 mb-1" id='CTM_plot'
    ...
    <div class="modal-content" id="modalwaitonContent">
      ...
      <div class="modal-body" id="modalwaitonBody">
        <div class="row col-md-12 ml-auto" style="overflow:hidden; font-size:10pt">
	     ...
	     <p id="modalwaitonLabel2" style="text-align:center;font-size:14px; margin-left:3px; margin-right:6px; border:0px solid red">Please wait as this process is complex and may take a few minutes. Many CTMs contain a large amount of data and the data may be interpolated before extracting</p>
           </div>
        </div>
      </div>
      <div class="modal-footer justify-content-center">
...
<!-- Map Option -->
		     ...
		     <button class="btn ctm-top-small-btn" data-toggle="modal" data-target="#modalinfo" data-info='Plots the source data points, which is useful to better understand the resolution of the plotted data. Note that all points are interpolated'><span class="glyphicon glyphicon-info-sign"></span></button>
                </div>
		     ...
		     <button class="btn ctm-top-small-btn" data-toggle="modal" data-target="#modaltinyinfo" data-info='Show Community Fault Model v7.0 on map'><span class="glyphicon glyphicon-info-sign"></span></button>
                </div>
		     ...
		     <button class="btn ctm-top-small-btn" data-toggle="modal" data-target="#modaltinyinfo" data-info='Show Cities on map'><span class="glyphicon glyphicon-info-sign"></span></button>
                 </div>
		     ...
		     <button class="btn ctm-top-small-btn" data-toggle="modal" data-target="#modaltinyinfo" data-info='Show plot only'><span class="glyphicon glyphicon-info-sign"></span></button>
                 </div>
		     ...
		     <button class="btn ctm-top-small-btn" data-toggle="modal" data-target="#modalinfo" data-info='The plot defaults to cover the entire range of the data; however sometimes it is useful to force a color range to compare two plots with different data ranges'><span class="glyphicon glyphicon-info-sign"></span></button>
		 ...
		 <div style="text-align:center">
                     <button id="replotNow" onclick="replotPlots()" class="ctm2-btn btn btn-dark mt-4" style="width:50%;border-radius:0.25rem;"><i class="fa fa-refresh" aria-hidden="true"></i>
 REPLOT</button>
                 </div>

                 <div class="form-check form-check-inline mt-2" style="">
                    <button id="viewPlotSavePNGbtn" class="ctm-btn ml-1" onclick="savePNGPlotview()"><i class="fa fa-picture-o" aria-hidden="true"></i>
 PNG</button>
                    <button id="viewPlotSavePDFbtn" class="ctm-btn ml-2" onclick="savePDFPlotview()"><i class="fa fa-file-pdf-o" aria-hidden="true"></i>
 PDF</button>
                 </div>
...
<!-- Window Options -->
                 <div class="form-check form-check-inline mt-2">
                   <button id="viewPlotMovebtn" class="ctm-btn ml-1" onclick="movePlotview()"><i class="fa fa-window-restore" aria-hidden="true"></i>
 Pop Out</button>
                   <button id="viewPlotClosebtn" class="ctm-btn ml-2" data-dismiss="modal"><i class="fa fa-window-close" aria-hidden="true"></i>
 Close</button>
                 </div>
             </div>
             </div>
