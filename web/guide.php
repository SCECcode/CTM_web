...
<a href="https://www.scec.org/research/ctm">UCVM version 25.X</a> release. It allows users to extract and visualize velocities of P and S waves and densities from different Community Velocity Models. The CVM Explorer currently has the functionality to produce various visualizations of the models including: 2D horizontal slices, 2D vertical cross sections, 1D vertical profiles, and individual 0D points from the extracted data.</p>
